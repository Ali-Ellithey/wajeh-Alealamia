...
const FamilyCarsDetails = () => {
  ...
  // إعدادات السلايدر العلوي (نفس نظام الصفحات السابقة)
  const slides = [
    {
      img: imgSlider1,
      title: (
  ...
  return (
    <>
      {/* 🖼️ Section 1: Hero Slider (بديل الفيديو) */}
      ...
      {/* 🚗 Section 2: Fleet Fleet */}
      <Container className="my-5" dir="rtl">
        <h2 className="text-center fw-bold">أسطول السيارات العائلية الفاخرة</h2>
        <div className="title-line mx-auto mb-5"></div>
