...
import img2 from "/public/cars/porshe-B-2023webp.webp";

// استيراد صور السلايدر العلوي (Hero)
  ...
  const familyCars = [
    {
      ...
      whatsappLink:
        "https://wa.me/+96590930061?text=أريد حجز بنتلي بينتايجا العائلية",
    },
    {
      id: 2,
      ...
      rentalOptions: { minAge: 21 },
      whatsappLink:
        "https://wa.me/+96590930061?text=أريد حجز مرسيدس مايباخ العائلية",
    },
  ];
    ...
    <>
      ...
      <section className="bg-white py-5 border-bottom overflow-hidden">
        ...
        >
          <h2 className="brand-main-title fw-bold mb-3">
            {t("brands_section.title") || "شركاء الفخامة"}
          </h2>
        ...
        <div
          className="d-flex overflow-hidden position-relative pt-2"
          style={{ direction: "ltr" }}
        >
          <motion.div
      ...
      <Container className="my-5" dir="rtl">
        <div className="text-center mb-5">
          <h2 className="fw-bold">أسطول السيارات العائلية الفاخرة</h2>
          <div className="title-separator mx-auto">
            <span className="dot"></span>
      ...
      <style>{`
        ...
        .title-separator { display: flex; align-items: center; justify-content: center; gap: 12px; }
        .title-separator .line { height: 2px; background: linear-gradient(to right, transparent, #fc8b1a, transparent); width: 150px; }
